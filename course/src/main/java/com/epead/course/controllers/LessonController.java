...
import com.epead.course.dtos.LessonDto;
...
import com.epead.course.specifications.SpecificationTemplate;
...
public class LessonController {
    ...
    public ResponseEntity<Page<LessonModel>> getAllLessons(@PathVariable(value="moduleId") UUID moduleId,
        ...
        return ResponseEntity.status(HttpStatus.OK).body(lessonService.findAllByModule(SpecificationTemplate.lessonCourseId(moduleId).and(spec), pageable));
    }
